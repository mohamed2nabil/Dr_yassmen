        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12 py-10 flex flex-col lg:flex-row lg:items-end justify-between gap-6">
          <div>
            <div
              ...
              style={{ fontFamily: "var(--font-mono)", fontSize: "0.68rem", letterSpacing: "0.16em", textTransform: "uppercase", color: "var(--chapter-therapy)" }}
            >
              <span className="h-px w-6" style={{ background: "var(--chapter-therapy)" }} />
              Chapter 04
            </div>
            <h2
              style={{
          ...
          >
            When art becomes a pathway to healing — working with individuals and groups to support emotional wellbeing, trauma recovery, and psychological growth.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        ...
        <div className="grid lg:grid-cols-12 gap-12 mb-20">
          <div className="lg:col-span-5">
            <p style={{ fontFamily: "var(--font-body)", fontSize: "1rem", lineHeight: 1.85, color: "var(--muted-foreground)" }}>
              With over 12 years of clinical practice, I offer art therapy as a BAAT-accredited practitioner. My approach is trauma-informed, person-centered, and grounded in the belief that creativity is an innate human capacity for healing — not a talent that needs to be earned.
            </p>
            <p className="mt-5" style={{ fontFamily: "var(--font-body)", fontSize: "1rem", lineHeight: 1.85, color: "var(--muted-foreground)" }}>
            ...
            {workshops.map((w, i) => {
              ...
              return (
                <button
                  ...
                  style={{
                    background: activeWorkshop === i ? "var(--chapter-therapy-bg)" : "var(--card)",
                ...
                >
                  <div
                    ...
                    style={{ background: "var(--chapter-therapy-bg)", borderRadius: "50%" }}
                  >
                    <Icon size={16} style={{ color: "var(--chapter-therapy)" }} />
                  </div>
                  <div style={{ fontFamily: "var(--font-display)", fontSize: "1rem", color: "var(--foreground)" }}>{w.title}</div>
                  <div style={{ fontFamily: "var(--font-display)", fontSize: "0.8rem", color: "var(--chapter-therapy)", fontStyle: "italic", marginTop: "2px" }}>{w.arabic}</div>
                  {activeWorkshop === i && (
                    <div className="mt-4">
                      <p style={{ fontFamily: "var(--font-body)", fontSize: "0.82rem", lineHeight: 1.7, color: "var(--muted-foreground)" }}>{w.description}</p>
        ...
        <div>
          ...
          <div
            ...
            style={{ background: "var(--chapter-therapy-bg)", border: "1px solid rgba(74,122,95,0.15)" }}
          >
            <div
              className="mb-1 px-4 py-2"
              style={{ fontFamily: "var(--font-mono)", fontSize: "0.62rem", letterSpacing: "0.1em", textTransform: "uppercase", color: "var(--chapter-therapy)", opacity: 0.7 }}
            >
            ...
            <div className="grid lg:grid-cols-3 gap-1">
              {stories.map((s, i) => (
                <button
                  ...
                  style={{
                    background: activeStory === i ? "var(--card)" : "transparent",
                  }}
                >
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <div>
                      <div style={{ fontFamily: "var(--font-mono)", fontSize: "0.65rem", color: s.color, letterSpacing: "0.08em", textTransform: "uppercase" }}>{s.context}</div>
                      <div style={{ fontFamily: "var(--font-body)", fontSize: "0.75rem", color: "var(--muted-foreground)" }}>Age {s.age}</div>
                    </div>
                  </div>
                  <p
                    style={{
